...
class EventManager {
    ...
    beforeinput(event) {
        ...
        if (jsRange) {
            let range = new Range(Position.fromNode(editor._renderTree, jsRange.startContainer, jsRange.startOffset), Position.fromNode(editor._renderTree, jsRange.endContainer, jsRange.endOffset));
        ...
        let insertData = event.data || ((_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.getData('text/plain')) || null;
...
export { DOMParser, Editor, MobiledocError as Error, ImageCard, MOBILEDOC_VERSION$4 as MOBILEDOC_VERSION, Position, PostNodeBuilder, Range, mobiledocRenderers as Renderer, ui as UI, version as VERSION };
